...
public class LayerManager { //Layer를 관리해주는 클래스(계층간 연결)
	...
	private int m_nTop;
	private static int m_nLayerCount;

	private ArrayList<BaseLayer> mp_Stack = new ArrayList<BaseLayer>();
	private static ArrayList<BaseLayer> mp_aLayers = new ArrayList<BaseLayer>() ;//chatapp,socket,IPCDIG들을 저장
	...
	public static BaseLayer GetLayer(String pName){
